...
6. If a paper order is deliberately authorized, demonstrate reconciliation, `trade_updates`, guardian exit, dashboard journal, and `vegaguard live lifecycle-evidence`. Otherwise state that no P&L has been generated.

    ...
    def _worker_status(
        ...
        *,
        ...
        return {
            ...
            "recovered_spread_count": payload.get("recovered_spread_count"),
            "matched_leg_count": payload.get("matched_leg_count"),
            "matched_legs": payload.get("matched_legs") or [],
            "unmatched_spread_count": payload.get("unmatched_spread_count"),
            "last_reconciliation_at": payload.get("last_reconciliation_at"),
